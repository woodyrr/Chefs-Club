...
export default defineEventHandler(async (event) => {
    ...
    const meals = [
      { name: 'Fajita Chicken Pasta', category: 'Dinner', time: {type:"minutes", min:30, max:45 }, dificulty:"easy", Cook:"Woodro", area: 'unknown', Visibility:"Public", img:'https://theflavoursofkitchen.com/wp-content/uploads/2020/04/Creamy-Chicken-Fajita-Pasta-2.jpg',
        "ingredients":{
            "pasta": {
